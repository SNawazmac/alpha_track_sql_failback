param(
[Parameter(Mandatory=$true)][string]$primary_sql_server_resource_group_name,                     #Enter the name of resource group where the primary sql server is existing
[Parameter(Mandatory=$true)][string]$primary_sql_server_name,                     #Enter the secondary server name
...
Switch-AzSqlDatabaseFailoverGroup -ResourceGroupName $primary_sql_server_resource_group_name -ServerName $primary_sql_server_name -FailoverGroupName $failover_group_name
